...
library("DiagrammeR")
# Must build in option to install packages only if they are not already installed
# Sample code for this can be found in Professor Kanishka's sample code
...
```{r flow_diagram, fig.height = 2, fig.width = 10, fig.align = "center", echo = FALSE}
